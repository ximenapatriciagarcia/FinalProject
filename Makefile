...
main: main.o Video.o Movie.o Series.o Season.o Episode.o InvalidRatingException.o EmptyFieldException.o InvalidNumberException.o DivideByZeroException.o
	$(CXX) $(CXXFLAGS) -o main main.o Video.o Movie.o Series.o Season.o Episode.o InvalidRatingException.o EmptyFieldException.o InvalidNumberException.o DivideByZeroException.o
